...
void Battle :: set_active(int _level, bool _ghostTetromino, Effect _effect, Mode _mode){
     active = true;

     //reset move time
     player1->set_active(_level, _ghostTetromino, _effect, _mode);
     player2->set_active(_level, _ghostTetromino, _effect, _mode);
}
